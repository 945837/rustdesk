...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rustdesk.wx110.com"];
pub const PUBLIC_RS_PUB_KEY: &str = "x6oat54tjOFFISweDpFcWdAhSxCnSddB6RJrxd+itK8=";
...
pub const RENDEZVOUS_PORT: i32 = 28116;
pub const RELAY_PORT: i32 = 28117;
